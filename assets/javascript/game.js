...
// array to store the letters tried by the player - empty at the beginning
var lettersTried = [];
...
// function to randomly choose the word within the array of choices
...
// function to reveal the letter (or letters if one letter appears more than once) when part of the word
...
function revealGoodGuess(goodGuess) {
...
// function to reset the number og letters guessed
...
document.onkeyup = function(event) {
    ...
    // if there is still letter to guess and if the number of guesses
    // remaining is superior at 0, play the game
    if ((numberGuessed < selectedWord.length) && (guessesRemaining > 0)) {
        
        // the player chooses a key = its first guess
        ...
        // if the letter tried is part of the word
            ...
            // the good guess will be displayed at the right place on the word hidden on the screen
            revealGoodGuess(playerGuess);
        }
